...
* 1분 자기소개
  ...
  ```
  안녕하십니까 제조 IT 직무에 지원한 제조업에 대한 전문성을 지닌 SW개발자 오진석입니다.
...
* 입사를 위해 어떤 준비(노력)를 해 왔습니까?
  ...
  ```
  저는 현대 오토에버에 입사하기 위해 직무를 수행할 수 있는 전문성을 키웠다.
  ```
...
* 해당 산업에 관심을 가지게 된 계기
  ...
  ```
  저는 부모님이 공장을 운영하실 때 품질에 대한 고민을 하시는 모습을 보고 제조 기술에 대한 관심을 가지게 됐고, 그 중에서도 현재 제조업을 한 단계 더 발전시키기 위해서는 IT 기술이 더 중요하다는 생각을 가지게 됐고 이에 IT 산업에 관심을 가지게 됐습니다.
  ```
...
* 지원한 직무로서 성장할 때 어떤 CDP(Career Development Program)를 계획하고 있는가?
  ...
  ```
  생산, 물류, 재무, 회계, 영업, 구매 등 경영활동 프로세스를 통합적으로 연계하여 관리하는 시스템
  ```
...
* 학교를 남들보다 오래 다닌 것 샅은데 이유가 있습니까?
  ...
  ```
  모두들 저희가 선정한 창업 주제를 확신하지 못했고 공모전에서 당선될 때까지 주제를 계속해서 바꿨기 때문에 실제 창업을 해보지도 못해서 실패하게 됐습니다.
  ```
