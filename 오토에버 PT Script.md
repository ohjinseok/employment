...
* 1분 자기소개
  ...
  현대오토에버에서 현대자동차그룹 공장의 스마트 팩토리화에
  기여하는 인재가 되도록 하겠습니다. 감사합니다.
  ```
...
* 문제점을 겪는 부분?
  ...
  ```
  제품 교정할 때 소비자의 요구에 맞게 형상을 완성시켜야 하는데
  이 부분이 숙련되지 않으면 어려움
  절단 과정에서는 알루미늄이 아직 연성이기 때문에
  큰 힘을 가하면 모양이 망가짐
  ```
...
* 회사 및 직무의 지원동기
  ...
  ```
  먼저 현대 오토에버에 지원하게 된 이유는 국내에서 최고
  ```
...
* 약간의 공백기간이 있던데 그 공백기간에 무엇을 했고 어떤 것을 배웠습니까?
...
* 인생에서 누군가와 갈들을 겪었던 경험과 그 갈등을 어떻게 해결하였는지 말씀해주십시오
